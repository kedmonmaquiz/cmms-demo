...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-3">
                                    ...
                                    <p class="text-muted text-truncate mb-0">Tasks this month</p>
                                </div>
                            </div>
                        </div><!-- end card body -->
                    </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Tasks Overview</h4>
                            <div>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mini-stats-wid d-flex align-items-center mt-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">Check for proper functioning of circulation system</h6>
                            <p class="text-muted mb-0">Fontain </p>
                        </div>
                    ...
                    <div class="mini-stats-wid d-flex align-items-center mt-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">check and ensure the access caps/ nodding eyes properly sealed and free from leakage</h6>
        ...
        <div class="col-xl-7">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h4 class="card-title flex-grow-1 mb-0">Active Tasks</h4>
                    <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="table-responsive table-card">
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-medium">check and ensure the access caps/ nodding eyes properly sealed and free from leakage</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label ms-1" for="checkTask1">
                                                Check for the Drainage pump
                                            </label>
                                        </div>
                                    </td>
                                    <td class="text-muted">03 June 2022</td>
    ...
    <div class="row">
                                            ...
                                            <div class="ctext-wrap">
                                                <div class="message-img mb-0">
                                                    <div class="message-img-list">
                                                        <div>
                                                            <a class="popup-img d-inline-block"
                                                                href="{{asset('assets/images/small/img-1.jpg')}}">
                                                    ...
                                                    <div class="message-img-list">
                                                        <div>
                                                            <a class="popup-img d-inline-block"
                                                                href="{{asset('assets/images/small/img-2.jpg')}}">
        ...
        <div class="col-xxl-4 col-lg-6">
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Task Status</h4>
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown">
