                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                                <thead class="table-light text-muted">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="project_name">Equipment</th>
                                                        ...
                                                        <th class="sort" data-sort="frequency">Frequency</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="project_name"><a href="" class="fw-medium link-primary">Fontain</a></td>
                                            
                                                        
                                                        <td class="client_name">Ground Floor</td>
                                                        <td class="task_name">Check for inlet vacuum, sunction valves, pipes and fitting for leakage</td>
                                                        <td class="assignedto">
                                                        ...
                                                        <td class="due_date">25 May, 2022</td>
                                                        <td class="frequency"><span class="badge badge-soft-secondary text-uppercase">Weekly</span></td>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="frank-hook">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-3.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Frank Hook
                                                                        </span>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="alexis-clarke">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-6.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Alexis Clarke
                                                                        </span>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="herbert-stokes">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Herbert Stokes
                                                                        </span>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="nancy-martino">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-5.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Nancy Martino
                                                                        </span>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="thomas-taylor">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-8.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Thomas Taylor
                                                                        </span>
                                                            ...
                                                            <li>
                                                                <div class="form-check d-flex align-items-center">
                                                                    ...
                                                                    <label class="form-check-label d-flex align-items-center" for="tonya-noble">
                                                                        <span class="flex-shrink-0">
                                                                            <img src="{{asset('assets/images/users/avatar-10.jpg')}}" alt="" class="avatar-xxs rounded-circle">
                                                                        </span>
                                                                        <span class="flex-grow-1 ms-2">
                                                                            Tonya Noble
                                                                        </span>
